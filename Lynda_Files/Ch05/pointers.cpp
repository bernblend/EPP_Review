...
int main()
{
	...
	cout << "Johns acct number: " << JohnsAcct << " is at: " << acctPtr << endl;  //shows memory address.
	cout << "acctPtr points to this value: *acctPtr:" << *acctPtr << endl;    //shows value of reference variable.
	...
	*numPtr += 5;  //num value is now 100
	...
	char letter = 'A';
	cout << "size of letter value based on datatype: " << sizeof(letter) << endl;
